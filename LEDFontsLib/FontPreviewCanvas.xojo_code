	...
	#tag Method, Flags = &h21
		Private Sub InternalDrawText(g As Graphics, txt As String)
		  ...
		  For i As Integer = 0 To txt.Length - 1
		    ...
		    x = x + FontObject.GlyphAdvance(ch)
		  Next
		End Sub
	#tag EndMethod
	...
	#tag Method, Flags = &h0
		Sub Render(g As Graphics)
		  ...
		  If FontObject IsA BitmapLCDFont Then
		    ...
		    Var visibleText As String = lcd.Message.Middle(lcd.ScrollIndex)
		    InternalDrawText(g, visibleText)
		    Return
		  End If
		  ...
		  If FontObject IsA BitmapFNTFont Then
		    ...
		    For i As Integer = 0 To fnt.Message.Length - 1
		      totalWidth = totalWidth + FontObject.GlyphAdvance(fnt.Message.Middle(i, 1))
		    Next
		    ...
		    While drawX < g.Width
		      For i As Integer = 0 To fnt.Message.Length - 1
		        ...
		        drawX = drawX + FontObject.GlyphAdvance(ch)
